...
export default function NewFarmerForm({user}) {
  ...
  return (
    ...
    <div className="grid gap-4 sm:grid-cols-2 sm:gap-6">
      ...
      <TextInput label="What is the Size of Your Land in Accres" name="landSize" type='number' register={register} errors={errors} className='w-full' />
      <TextInput label="What is your main Crop that you Cultivate" name="mainCrop" type='text' register={register} errors={errors} className='w-full' />
